...
class SVNTest (Test):
    ...
    def checkout (self):
        ...
        self.repo.checkout ('gnome-common', '/tmp/', newdir = 'gnome-common-2.16', branch = 'gnome-2-16')
    ...
    def diff (self):
        try:
            # Using a local path
            self.repo.diff ('/tmp/gnome-common', files = ['ChangeLog'], revs = ['3900', '3901'])
        except:
        ...
        try:
            # Using an URI
            self.repo.diff ('http://svn.gnome.org/svn/gnome-common', branch = 'gnome-2-16', files = ['macros/autogen.sh'], revs = ['3875', '2834'])
    ...
    def get_modules (self):
        try:
            # First layout
            repo = create_repository ('svn', 'http://svn.gnome.org/svn/gnome-common')
        ...
        try:
            # Second layout
            repo = create_repository ('svn', 'https://svn.forge.morfeo-project.org/svn/libresoft-tools')
